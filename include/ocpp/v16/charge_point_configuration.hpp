...
public:
    ...
    void setChargepointModemInformation(const NullOrOptionalString& ICCID, const NullOrOptionalString& IMSI);
    void setChargepointMeterInformation(const NullOrOptionalString& meterSerialNumber,
