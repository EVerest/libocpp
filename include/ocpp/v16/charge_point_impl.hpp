...
private:
    ...
    void heartbeat(const bool initiated_by_trigger_message = false);
    void boot_notification(const bool initiated_by_trigger_message = false);
    ...
    void send_meter_value(int32_t connector, MeterValue meter_value, const bool initiated_by_trigger_message = false);
