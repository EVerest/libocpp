...
public:
    ...
    int bind_text(const int idx, const std::string& val) {
        return sqlite3_bind_text(this->stmt, idx, val.c_str(), val.length(), SQLITE_TRANSIENT);
    }
