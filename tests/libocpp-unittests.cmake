...
function(add_libocpp_unittest)
    ...
    if (arg_libocpp_unittest_PATH)
        add_executable(${arg_libocpp_unittest_NAME} ${arg_libocpp_unittest_PATH})
    else ()
        add_executable(${arg_libocpp_unittest_NAME})
    endif()
    add_test(NAME ${arg_libocpp_unittest_NAME} COMMAND ${arg_libocpp_unittest_NAME} WORKING_DIRECTORY ${CMAKE_CURRENT_BINARY_DIR})
    ...
    message("Add test ${arg_libocpp_unittest_NAME}")
endfunction()
