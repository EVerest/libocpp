...
create_charging_profile(int32_t charging_profile_id, ChargingProfilePurposeEnum charging_profile_purpose,
                        ...
                        std::optional<ocpp::DateTime> validFrom, std::optional<ocpp::DateTime> validTo) {
...
void CompositeScheduleTestFixtureV201::SetUp() {
}

void CompositeScheduleTestFixtureV201::TearDown() {
}

void CompositeScheduleTestFixtureV201::load_charging_profiles_for_evse(const std::filesystem::path& path,
                                                                       int32_t evse_id) {
...
CompositeScheduleTestFixtureV201::CompositeScheduleTestFixtureV201() :
...
CompositeScheduleTestFixtureV201::create_smart_charging_handler(const OcppProtocolVersion ocpp_version) {
...
void CompositeScheduleTestFixtureV201::reconfigure_for_nr_of_evses(int32_t nr_of_evses) {
    this->evse_manager = std::make_unique<EvseManagerFake>(nr_of_evses);
    this->handler = std::make_unique<TestSmartCharging>(
        *device_model, *this->evse_manager, connectivity_manager, mock_dispatcher, *database_handler,
