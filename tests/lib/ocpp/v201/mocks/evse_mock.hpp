...
public:
    ...
    MOCK_METHOD(void, set_meter_value_pricing_triggers, (std::optional<double> trigger_metervalue_on_power_kw, std::optional<double> trigger_metervalue_on_energy_kwh,
