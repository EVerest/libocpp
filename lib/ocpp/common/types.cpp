...
std::string certificate_type_to_string(CertificateType e) {
    switch (e) {
        case CertificateType::V2GRootCertificae: return "V2GRootCertificae";
...
CertificateType string_to_certificate_type(std::string s) {
    if(s == "V2GRootCertificae") {
        return CertificateType::V2GRootCertificae;
    }
