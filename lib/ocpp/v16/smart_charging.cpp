...
EnhancedChargingSchedule SmartChargingHandler::calculate_enhanced_composite_schedule(
    ...
    auto composite_charge_point_max = ocpp::v16::calculate_composite_schedule(
        charge_point_max, start_time, end_time, charging_rate_unit, default_number_phases);
    auto composite_tx_default = ocpp::v16::calculate_composite_schedule(tx_default, start_time, end_time,
                                                                        charging_rate_unit, default_number_phases);
    auto composite_tx =
        ocpp::v16::calculate_composite_schedule(tx, start_time, end_time, charging_rate_unit, default_number_phases);
