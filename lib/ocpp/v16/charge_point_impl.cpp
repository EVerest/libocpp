...
void ChargePointImpl::heartbeat(const bool initiated_by_trigger_message) {
...
void ChargePointImpl::boot_notification(const bool initiated_by_trigger_message) {
...
void ChargePointImpl::log_status_notification(UploadLogStatusEnumType status, int requestId, const bool initiated_by_trigger_message) {
