# OCPP V2.0.1 Smart Charging Functional Requirement Flows
...
| Error         | Description      | FR(s) (if applicable)      |
| ------------- | ------------- | ------------- |
| `ChargingProfileFirstStartScheduleIsNotZero` | The `startPeriod` of the first `chargingSchedulePeriod` needs to be 0. | K01.FR.31 |
